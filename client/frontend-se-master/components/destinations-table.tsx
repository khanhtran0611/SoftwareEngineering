...
import { getAllDestinations, createDestination, updateDestination, deleteDestination, getDestinationsFromStorage } from "@/lib/destination"
...
export default function DestinationsTable({ searchQuery }: DestinationsTableProps) {
  ...
  useEffect(() => {
    const fetchDestinations = async () => {
      setIsLoading(true)
      try {
        const data = getDestinationsFromStorage()
