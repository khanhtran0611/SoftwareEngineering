        ...
        <div className="container mx-auto px-4 py-8">
            ...
            <div className="flex flex-wrap items-start justify-between gap-4">
              ...
              <div className="flex items-center gap-1">
                ...
                <span className="text-lg font-medium">
                  {typeof averageRating === 'number' && averageRating !== 0 ? averageRating : "No reviews"}
                </span>
              </div>
            </div>
          ...
          <div className="space-y-8">
            ...
            <Card className="p-6">
              ...
              <p className="mb-6 max-w-none">{hotel.description}</p>


              <div className="prose max-w-none">
                <p>
                  {hotel.name} is located in {hotel.address}, offering comfortable accommodations for travelers visiting
                  Vietnam. {averageRating !== null && averageRating !== 0 ? `With a rating of ${averageRating.toFixed(1)} stars, this` : "This"}{" "}
