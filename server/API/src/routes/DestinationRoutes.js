...
const uploadPath = process.env.IMAGE_STORAGE + '/destinations'
...
router.post('/api/filter', DestinationController.FilterDestination)
...
router.post('/recommend', DestinationController.getDestinationRecommendations)
