...
const BookingRoom = "INSERT INTO Booking (user_id, room_id, status, total_price, check_in_date, check_out_date,people,created_at) VALUES ($1, $2, 'pending', $3, $4, $5,$6,NOW()) RETURNING *;"
...
const signin = "INSERT INTO \"User\" (name, email, phone_number, gender, date_of_birth, role, password) VALUES ($1, $2, $3, $4, $5, $6, $7);"
...
const updatePassword = `
    ...
    RETURNING *;
`
const updatePasswordBasedEmail = `
    UPDATE "User" 
    SET password = $2
    WHERE email = $1
    RETURNING *;
