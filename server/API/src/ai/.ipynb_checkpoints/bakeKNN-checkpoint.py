...
from ContentKNNAlgorithm import ContentKNNAlgorithm  # Thêm dòng này
...
class RecSysMain:
    def __init__(self, ratings_path="./dataset/ratings.csv", model_path="contentknn_algo.pkl"):
        ...
        self.algo = algo_cls()  # Khởi tạo thuật toán truyền vào
    ...
    def recommend(self, user_id=1):
        ...
        print ("\nI recommend for user "+str(user_id)+": ")
        for userID, hotelID, actualRating, estimatedRating, _ in predictions:
            intHotelID = int(hotelID)
            recommendations.append((intHotelID, estimatedRating))
